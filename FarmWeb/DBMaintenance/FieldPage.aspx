<%@ Page Title="" Language="VB" MasterPageFile="AdminMaster.master" AutoEventWireup="false" CodeFile="FieldPage.aspx.vb" Inherits="DBMaintenance_FieldPage" %>


<asp:Content ID="FieldMaintContent" ContentPlaceHolderID="adminMainContentHolder" Runat="Server">

<div class="tableHolder">

    <h2>
        Field Maintenance Page<asp:ImageButton ID="btnField" runat="server" ImageUrl="~/Images/spacer.gif" 
    ...
    <asp:ListView ID="lvFields" runat="server" 
        ...
        <EditItemTemplate>
            <tr style="background-color: #FFCC66;color: #000080;">
                ...
                <td>
                    <asp:Label ID="FieldIDLabel" runat="server" Text='<%# Bind("FieldID") %>' />
                </td>
                <td>
                    <asp:TextBox ID="FieldNameTextBox"  MaxLength="50" runat="server" 
                        Text='<%# Bind("FieldName") %>' />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFieldName" 
                        ...
                        ControlToValidate="FieldNameTextBox" ValidationGroup="EditField"></asp:RequiredFieldValidator>
                </td>
                <td>
                    <asp:TextBox ID="AcresTextBox"  MaxLength="5" runat="server" 
                        Text='<%# Bind("Acres") %>' Width="35" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFeildAcres" 
                        runat="server" ErrorMessage="<br>Required" 
                        CssClass="validation" Display="Dynamic" 
                        ControlToValidate="AcresTextBox" ValidationGroup="EditField"></asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="CompareValidatorFieldAcres" runat="server" 
                        ControlToValidate="AcresTextBox" CssClass="validation" 
                        Display="Dynamic" ErrorMessage="<br>must be positive." 
                        Operator="GreaterThanEqual" Type="Integer" ValueToCompare="0" 
                        ValidationGroup="EditField"></asp:CompareValidator>
                </td>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFieldOwnerName" 
                        ...
                        ValidationGroup="EditField"></asp:RequiredFieldValidator>
                </td>
                <td>
                    <asp:CheckBox ID="ActiveCheckBox" runat="server" 
                        Checked='<%# Bind("Active") %>' />
                 ...
                 <td>
                    <asp:ImageButton ID="UpdateButton" runat="server" CommandName="Update" 
                        Text="Update" ValidationGroup="EditField" ImageUrl="~/Images/update20_20.png" Height="19" Width="19" />
            ...
            <tr style="">
                ...
                <td>
                    <asp:ImageButton ID="InsertButton" runat="server" CommandName="Insert" 
                        Text="Insert" ValidationGroup="InsertField" ImageUrl="~/Images/insert20_20.png" />
                    <asp:ImageButton ID="CancelButton" runat="server" CommandName="Cancel" 
